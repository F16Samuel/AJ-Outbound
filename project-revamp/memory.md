# Tally — durable memory

Context that must survive a context reset. Update continuously, not at the end.

## Identity

- Repo: `F16Samuel/tally` (renamed from AJ-Outbound)
- Product name: **Tally** — Outbound Without The Spreadsheet
...
- **Read the README before describing this project.** Two project descriptions
  ...
  `gh api repos/F16Samuel/tally/readme -q .content | base64 -d | head -20`
